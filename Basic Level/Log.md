...
- B1065   两个int相除变成double类型的，必须对被除数*1.0或强制转换(double)
- B1066   //
...
B1033(旧键盘打字)、B1035(插入与归并)、B1040(有几个PAT)、B1044(火星数字)、B1045(快速排序)、B1050(螺旋矩阵)、B1052(卖个萌)、B1054(求平均值)、B1055(集体照)、B1060(爱丁顿数)、B1062(最简分数)、B1065(单身狗)、B1068(万绿丛中一点红)